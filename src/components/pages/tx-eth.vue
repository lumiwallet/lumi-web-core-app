      ...
      .group
        ...
        .group__body
          ...
          .group-row.group-row--m-margin
            label Data
            input(v-model="tx.data" type="text" placeholder="")
          .group-row.group-row--m-margin
            label From
            input(v-model="tx.from" type="text" placeholder="")
          .group-row
            error(:show="!!error") {{ error }}
            button(@click="makeTx") Build
    modal(v-model="showModal" title="ETH transaction")
