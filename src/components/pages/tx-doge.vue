...
<script>
  ...
  import addInputComponent  from '@/components/partials/DOGE/addDogeInput'
  import addOutputComponent from '@/components/partials/DOGE/addDogeOutput'
